...
const Navbar = () => {
    ...
    return ( 
        <div className={`${style.navbar} ${location.pathname === "/" && !hamburger && style.white}`}>
            <div className={`${style.navbarContainer} ${hamburger && style.clickedHam}`}>
                ...
                <div className={style.hamburger} onClick={handleClick}>
                    ...
                    <div className={style.link}>
                        <NavLink exact to="/" activeClassName={style.active} onClick={handleClick}>Home</NavLink></div>
                    <div className={style.link}>
                        <NavLink exact to="/about" activeClassName={style.active} onClick={handleClick}>About</NavLink>
                    </div>
                    <div className={style.link}>
                        <NavLink exact to="/products" activeClassName={style.active} onClick={handleClick}>Shop</NavLink>
                    </div>
                </div>
